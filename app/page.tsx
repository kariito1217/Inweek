  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {/* Large floating circles with dramatic movement */}
        <div
        ...
        {/* Floating squares with rotation and movement */}
        <div
          className="absolute top-60 left-1/4 w-10 h-10 bg-cyan-200/40 rotate-45 shadow-lg"
          style={{
            animationDelay: "0.5s",
            animation: "pulse 2s infinite, rotate-float 12s linear infinite, float-up-down 4s ease-in-out infinite",
          }}
        ></div>
        <div
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col justify-center min-h-screen px-4 sm:px-8">
        <div className="max-w-6xl mx-auto w-full">
          <div className="flex justify-center items-end min-h-screen pb-16 xs:pb-18 sm:pb-20 md:pb-24 lg:pb-20 xs:justify-end xs:pr-2 sm:justify-end sm:pr-4 md:pr-8 lg:pr-12">
      ...
      <style jsx>{`
        ...
        /* Adding neon pulse expanding border animation */
        .neon-pulse::before,
        .neon-pulse::after {
          content: "";
          position: absolute;
